...
if __name__ == "__main__":
    AI_players = [ANET(size = 6), ANET(size = 6)] #, ANET(size = 3, player = 2)]
    # print(AI_players)
    AI_players[0].load_model('checkpoint55heur.pth.tar')
    AI_players[1].load_model('checkpoint29heur.pth.tar')
    ...
    game.player_names = ["55", "29"]#, "model_6"]
    while True:
        game.run_game() 
